 ...
 */
final class Version20220117090130 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE upload DROP FOREIGN KEY FK_17BDE61F83BA6D1B');
        $this->addSql('DROP INDEX IDX_17BDE61F83BA6D1B ON upload');
